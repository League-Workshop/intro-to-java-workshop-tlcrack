...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("aMAZing.jpg"));
...
showScaryImage("download.png");
JOptionPane.showMessageDialog(null, "You lost. Inky is disappointed in you.");
	}
